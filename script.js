document.addEventListener('DOMContentLoaded', () => {
    ...
    const rankingData = [
        ...
        { rank: 28, title: "フォニイ", videoId: "9QLT1Aw_45s", status: "(予測2027年10月後半)", pubDate: "20210605", type: "pending" },
    ...
    if (rankingBody) {
        (async () => {
            ...
            for (const item of rankingData) {
                ...
                else if (item.type === 'new_entry') statusClass = 'status-new';
